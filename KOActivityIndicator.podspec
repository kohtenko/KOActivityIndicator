#
#  Be sure to run `pod spec lint KOActivityIndicator.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/KOActivityIndicator"
  ...
  s.source       = { :git => "http://EXAMPLE/KOActivityIndicator.git", :tag => "0.0.1" }
